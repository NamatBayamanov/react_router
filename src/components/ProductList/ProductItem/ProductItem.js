...
import { Vue } from "https://cdnjs.cloudflare.com/ajax/libs/vue/2.0.1/vue.min.js";
import { config } from 'vuera';


function ProductItem({ product }) {

  // let Vue = <script src="https://cdnjs.cloudflare.com/ajax/libs/vue/2.0.1/vue.min.js"></script>;



  // let Vue = "https://cdnjs.cloudflare.com/ajax/libs/vue/2.0.1/vue.min.js";
  ...
  return (
    <>
      <div className={classes.ProductItem}>
        ...
        <h1 className={classes.title}>Hover over the cards</h1>

        <div id="app" class={classes.container}>
